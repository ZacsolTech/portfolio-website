...
export const portfolio: PortfolioItem[] = [
  {
    ...
    flagshipFor: ["ai-automation"],
    journey: [
      {
        when: "Phase 1",
        title: "Framed the actual problem",
        body: "Students were not short of opportunities — they were short of any way to see them. Scope was set on turning inbox noise into a ranked, trackable pipeline, not on building another inbox.",
        deliverable: "Scope and success criteria",
      },
      {
        when: "Phase 2",
        title: "Wired the intake",
        body: "Direct Gmail integration handles automated processing and sync, with manual batch upload alongside it — parsed against real-time progress over WebSockets so a large import stays interactive instead of freezing.",
        deliverable: "Gmail sync and batch upload",
        image: 2,
      },
      {
        when: "Phase 3",
        title: "Grounded extraction in a schema",
        body: "LangChain and Mistral tool-calling extract against fixed schemas, so the output is a typed record the product can rank — not prose the UI has to re-parse.",
        deliverable: "Structured opportunity records",
        image: 0,
      },
      {
        when: "Phase 4",
        title: "Ranked against the student's profile",
        body: "A profile-fit system scores each opportunity on eligibility, so what surfaces first is what the student can actually win.",
        deliverable: "Fit ranking across the pipeline",
        image: 1,
      },
      {
        when: "Phase 5",
        title: "Pushed only what mattered",
        body: "High-priority matches go to WhatsApp through Twilio, and async backend jobs keep the app responsive under load. Shipped on Vercel and Render.",
        deliverable: "WhatsApp alerts and production deploy",
        image: 3,
      },
    ],
  ...
  },
  {
    ...
    flagshipFor: ["data-science"],
    journey: [
      {
        when: "Phase 1",
        title: "Framed it as a field problem",
        body: "Detection had to work on a leaf photographed in the field, not a clean lab plate — and it had to justify itself, because an agronomist will not act on a label with no reasoning behind it.",
        deliverable: "Scope, dataset and target disease categories",
      },
      {
        when: "Phase 2",
        title: "Transfer learning instead of training from scratch",
        body: "VGG16 and Inception were combined under transfer learning, so a limited agricultural dataset still reached usable accuracy across disease categories rather than overfitting a small sample.",
        deliverable: "Trained classifier with accuracy reported per category",
      },
      {
        when: "Phase 3",
        title: "Made the model explain itself",
        body: "Grad-CAM heatmaps expose which regions of the leaf drove each prediction, so a user can see whether the model read the lesion or the background before trusting the result.",
        deliverable: "Grad-CAM interpretability layer",
        image: 1,
      },
      {
        when: "Phase 4",
        title: "Shipped inference someone can actually use",
        body: "A Streamlit app serves real-time predictions on uploaded leaf images — the model reaches the person in the field instead of staying in a notebook.",
        deliverable: "Deployed inference app",
        image: 0,
      },
    ],
  ...
  },
  {
    ...
    deployment: "n8n + HeyGen",
    flagshipFor: ["content-automation"],
    journey: [
      {
        when: "Phase 1",
        title: "Mapped the daily production loop",
        body: "Wrote down what a human did each morning — pull market data, read the news, draft a script, record. Every step became a node target.",
        deliverable: "Workflow map and tool selection",
      },
      {
        when: "Phase 2",
        title: "Built the data spine",
        body: "Binance spot and futures, CoinGecko, Fear & Greed, CryptoCompare and Cointelegraph RSS behind one scheduled trigger, with a prepare step that packs it into structured context.",
        deliverable: "Scheduled data pipeline",
        image: 1,
      },
      {
        when: "Phase 3",
        title: "Split the analysis across agents",
        body: "Three parallel agents — technical, fundamental, strategy — instead of one prompt carrying the whole judgement. Outputs merge before scripting.",
        deliverable: "Multi-agent analysis and two script variants",
        image: 2,
      },
      {
        when: "Phase 4",
        title: "Automated render and publish",
        body: "Scripts formatted into HeyGen payloads, avatar chosen by day, then a create-and-poll loop that retrieves final URLs once rendering finishes.",
        deliverable: "End-to-end run producing a finished video",
        image: 3,
      },
      {
        when: "Phase 5",
        title: "Proved it was brand-agnostic",
        body: "The same pipeline was repointed at fitness and Instagram vertical content by swapping data sources and avatar — not by rebuilding it.",
        deliverable: "Three brands running on one pipeline",
        image: 5,
      },
    ],
  },
